var config = {
	...
	'opendata' : {
		'host' : 'http://opendata.praha.eu',
		'pathSearch' : 'api/action/datastore_search',
		'pathSearchSQL' : 'api/action/datastore_search_sql',
		'resources' : {
			...
			'taxonomy' : '90e66377-9d31-4852-8cfb-1981319ccb20',
